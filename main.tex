...
\subsection*{Health Brain Network Preprocessed Open Diffusion Derivatives}
...
dat to incorporate considerations of data quality into their analysis of the
...
\rokemtodo[inline]{%
    Add discussion of limitations of expert QC. Here maybe we could discuss the
    max vs mean displacement bias. Maybe also refer to the difference between
    pairwise Cohen's $\kappa$ and ICC3k.
}
...
build upon and improve upon this work.
...
Here, this approach was generalized in several respects: first, from a single
volume of T1-weighted data to the multi-volume dMRI.
...
can be generalized even more widely in other projects and in other scientific
fields.
