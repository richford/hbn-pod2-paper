...
Structure (BIDS) and processed it acccording to best-practices, to
denoise it and correct for motion effects, susceptibility-related
distortions, and eddy currents. Analysis of these data requires considerations
of data quality. To scale quality control (QC) to these large data, we
...
out set.
The dataset both (a) deliver a resource for transdiagnostic
research in brain connectivity and pediatric mental health and (b) serve as a paradigm
