...
deep artificial neural networks, or ``deep learning'' \arhtodo{Cite Lecun et
al.'s 2015 deep learning review} are promising avenues for automation of QC. One
...
\arhtodo{This last sentence doesn't quite seem strong enough. Consider
...
transparent enough to interpret \arhtodo{cite relevant papers. the radiology
paper about the annotation of x-rays and so on}. Therefore, we used machine
...
\arhtodo{cite Bin Yu's intepretable machine learning paper and integrated
gradients paper}.
