...
\todo[inline]{Is that even what we want to keep calling this thing? If we're going to be more tool agnostic and allow reports outside of nipreps, what should we call the viewer? niQCV (neuroimaging quality control viewer)?}
