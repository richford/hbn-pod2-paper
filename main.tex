...
\arhtodo[inline]{Reference variant info in participants.tsv. And if this is the first time we're telling readers about participants.tsv, explain it.}
...
Figure \ref{fig:metric-dist} depicts the age distribution of study participants by sex and scan site as well as pairwise distributions for the three of these automated QC metrics that were most informative in QC models described later (see \ref{app:feature-importance} for further details).
...
\arhtodo[inline]{Mention the XGB-q docker image and streamlit app.}
...
\sctodo[inline]{Can you please add a citation for CuBIDS?}
