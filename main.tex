...
the data. We provide QC scores for the subjects that we have preprocessed,
paving the way for others to incorporate considerations of data quality into
their analysis of the processed data. Unsurprisingly, QC scores are strongly
directly correlated with age (Figure \ref{fig:dl-qc}}). This accords with the
negative association between head motion and age, which is well established both
in general
